...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FacebookLikebox.border_color'
        db.delete_column('cmsplugin_facebooklikebox', 'border_color')

        # Adding field 'FacebookLikebox.border'
        db.add_column('cmsplugin_facebooklikebox', 'border',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'FacebookLikebox.color_scheme'
        db.alter_column('cmsplugin_facebooklikebox', 'color_scheme', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Adding field 'FacebookLikebox.border_color'
        db.add_column('cmsplugin_facebooklikebox', 'border_color',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=50, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'FacebookLikebox.border'
        db.delete_column('cmsplugin_facebooklikebox', 'border')


        # Changing field 'FacebookLikebox.color_scheme'
        db.alter_column('cmsplugin_facebooklikebox', 'color_scheme', self.gf('django.db.models.fields.CharField')(max_length=50))
